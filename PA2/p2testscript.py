...
def compilerunfile():
    ...
    javac = "javac " + cwd + "/AddressBookTreeRunner.java" #compile solution file command and generate class file

    proc = subprocess.run([javac], capture_output=True, text = True, shell = True)
    

    
    java = "java AddressBookTreeRunner"
