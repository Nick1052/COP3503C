...
public class LotteryRunner {
    ...
    public static void main(String[] args) {
        ...
        if(Lottery.Solution1(ticketscollection, test, 999) == false &&
                Lottery.Solution1(ticketscollection, ticketscollection[index].GetTicket(), 999) ==
                        true)
        ...
        if(Lottery.Solution2(ticketscollection, 0, 999, test) == false &&
                Lottery.Solution2(ticketscollection, 0, 999, ticketscollection[index].GetTicket())
                        == true)
        ...
        if(Lottery.Solution1(ticketscollection, test, 1999) == false &&
                Lottery.Solution1(ticketscollection, ticketscollection[index].GetTicket(), 1999) ==
                        true)
        ...
        if(Lottery.Solution2(ticketscollection, 0, 1999, test) == false &&
                Lottery.Solution2(ticketscollection, 0, 1999, ticketscollection[index].GetTicket())
                        == true)
        ...
        if(Lottery.Solution1(ticketscollection, test, 4999) == false &&
                Lottery.Solution1(ticketscollection, ticketscollection[index].GetTicket(), 4999) ==
                        true)
        ...
        if(Lottery.Solution2(ticketscollection, 0, 4999, test) == false &&
                Lottery.Solution2(ticketscollection, 0, 4999, ticketscollection[index].GetTicket())
                        == true)
        ...
        if(Lottery.Solution1(ticketscollection, test, 8999) == false &&
                Lottery.Solution1(ticketscollection, ticketscollection[index].GetTicket(), 8999) ==
                        true)
        ...
        if(Lottery.Solution2(ticketscollection, 0, 8999, test) == false &&
                Lottery.Solution2(ticketscollection, 0, 8999, ticketscollection[index].GetTicket())
                        == true)
        ...
        if(Lottery.Solution1(ticketscollection, test, ticketscollection.length - 1)
                == true && Lottery.Solution1(ticketscollection,
                ticketscollection[index].GetTicket(), ticketscollection.length - 1) == true)
            System.out.println("Solution 1 Test 5 Passed!");
        else
            System.out.println("Solution 1 Test 5 Failed!");

        System.out.println("Testing Solution 2");
        if(Lottery.Solution2(ticketscollection, 0, ticketscollection.length - 1,
                test) == true && Lottery.Solution2(ticketscollection, 0, ticketscollection.length -
                1, ticketscollection[index].GetTicket()) == true)
